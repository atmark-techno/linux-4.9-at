 ...
 */
static void imx_uart_timeout(unsigned long data)
{
...
static void imx_uart_rs485_set_duplex(struct imx_port *sport, int duplex)
{
				 ...
				 struct serial_rs485 *rs485conf)
{
	...
	if (rs485conf->flags & SER_RS485_ENABLED) {
		/* set direction */
		imx_uart_rs485_set_duplex(sport, rs485conf->flags &
			     ...
			     struct platform_device *pdev)
{
	...
	if (of_get_property(np, "rts-gpio", NULL))
...
static int imx_uart_probe(struct platform_device *pdev)
{
	...
	sport->timer.function = imx_uart_timeout;
